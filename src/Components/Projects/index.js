  ...
  return (
    <div className="project">
      ...
      <div className="major-projects">
              ...
              <div className="project-flex">
                ...
                <ul className="project-list">
                  <li>
                    ...
                    list of jobs with search by Job title, filters based on
                    Salary range and Employment type, etc
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    details pages by using React Router components Route,
                    Switch, Link.
                  </li>
                  <li>
                  ...
                  <li>
                    Redirecting to the login page if the user tries to open
                    Home, Jobs, Job item details routes which need
                    authentication by implementing protected routes.
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="project-flex">
                ...
                <ul className="project-list">
                  ...
                  <li>
                    ...
                    user profile, profile by using React Router components
                    Route, Switch, Link.
                  </li>
                  <li>
                  ...
                  <li>
                    Implemented username and password authentication and
                    persisted login state using client storage.
                  </li>
                  <li>
          ...
          <a href="https://bhrejskrc.ccbp.tech" className="link">
            <div data-aos="zoom-in-up" className="project-container">
              ...
              <div className="project-flex">
                ...
                <ul className="project-list">
                  <li>
                    Implemented responsive Goodreads Clone where users can log
                    in and see a list of books, bookshelves like all shelves
                    (books sorted by rating), completed reading shelf, currently
                    reading shelf, want to read shelf , and user can also search
                    books with author's name and book's name.
                  </li>
                  <li>
                    Implemented different routes for features like login, home,
                  ...
                  <li>
                    ...
                    Third Party libraries called React Rating Stars, React
                    Select.
                  </li>
                  <li>
                    Used Figma mockups to implement UI-rich and pixel-perfect
                  ...
                  <li>
                    Used fetch to call REST APIs for a list of books,
                    bookshelves details and books search APIs.
                  </li>
                  <li>
                    Implemented username and password authentication and
                    persisted login state using client storage.
            ...
            <div data-aos="zoom-in-up" className="project-container">
              ...
              <div className="project-flex">
                ...
                <ul className="project-list">
                  ...
                  <li>
                    Implemented horizontal scrolling (carousel images on the
                    home page) using React Third Party library called React
                    Slick.
                  </li>
                  <li>
                    Used Figma mockups to implement UI-rich and pixel-perfect
                  ...
                  <li>
                    Used fetch to call REST APIs for popular restaurants with
                    sort by, specific restaurant details.
                  </li>
                  <li>
                    Implemented username and password authentication and
                    persisted login state using client storage.
        ...
        <Link className="link-btn" to="/minor-projects" onClick={onclickScroll}>
          <button type="button" className="minar-btn">
            Click On Me To Navigate Minor Projects
          </button>
        </Link>
      </div>
